                                ...
                                if (invField) {
                                    ...
                                    if (inventory) {
                                        ...
                                        if (fallDistance <= 9.0) {
                                            ...
                                            if (maceSlot == -1) maceSlot = FindHotbarSlot(env, inventory, "mace", "density");
                                            if (maceSlot == -1) maceSlot = FindHotbarSlot(env, inventory, "mace", nullptr);
                                        } else {
                                            // > 9 blocks: Try to find Density mace first
                                            maceSlot = FindHotbarSlot(env, inventory, "mace", "density");
                                            if (maceSlot == -1) maceSlot = FindHotbarSlot(env, inventory, "mace", "breach");
                                            if (maceSlot == -1) maceSlot = FindHotbarSlot(env, inventory, "mace", nullptr);
                                        }
